 ...
 *
 * Creates one customer and one organization with rich account data populated,
...
const GOLDEN_CUSTOMER = {
  ...
  age: '32',
  background: 'Golden test customer for v1.7.0 message content redaction testing',
...
const GOLDEN_ORG = {
  ...
  description: 'Fictional company used to verify field visibility across Help Scout API responses',
  brandColor: '#7C3AED',
};
